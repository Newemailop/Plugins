...
@hellbot.bot.on_message(filters.regex(r"New 💫") & filters.private)
...
@hellbot.bot.on_message(
    filters.regex(r"Delete ❌") & filters.private
)
...
@hellbot.bot.on_message(filters.regex(r"List 📜") & filters.private)
